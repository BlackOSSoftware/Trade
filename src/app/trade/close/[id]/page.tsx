...
export default function ClosePositionPage() {
        ...
        <>
            ...
            <div className="md:hidden flex flex-col  bg-[var(--bg-plan)] md:bg-[var(--bg-card)]">
                ...
                <div className="flex-1 mt-4">
                    <LiveChart
                        bid={Number(position.currentPrice)}
                        ask={Number(position.currentPrice)}
                    />
                </div>
                ...
                {/* BUTTON AREA */}
                <div className="p-4 md:p-6 border-t border-[var(--border-soft)]">
  ...
  <div className="w-[480px] bg-[var(--bg-card)] border-l border-[var(--border-soft)] flex flex-col">
    ...
    <div className="p-8 border-b border-[var(--border-soft)] bg-[var(--bg-plan)]">
      ...
      <div
        className={`mt-4 text-4xl font-bold mt-font ${
          livePnL >= 0
            ? "text-[var(--mt-blue)]"
            : "text-[var(--mt-red)]"
        }`}
    ...
    <div className="p-8 border-t border-[var(--border-soft)] bg-[var(--bg-plan)]">
      ...
      <button
        onClick={handleClose}
        disabled={isPending}
        className={`w-full h-14 rounded-xl text-lg font-semibold transition-all duration-200 active:scale-[0.98] shadow-md ${
          livePnL >= 0
            ? "bg-[var(--mt-blue)] text-white"
            : "bg-[var(--mt-red)] text-white"
...
function StatBlock({
  ...
  return (
    <div className="p-5 rounded-xl bg-[var(--bg-plan)] border border-[var(--border-soft)] hover:border-[var(--primary-glow)] transition-all duration-200">
      ...
      <div
        className={`mt-3 text-lg font-semibold mt-font ${
          success
            ? "text-[var(--mt-blue)]"
            : danger
              ? "text-[var(--mt-red)]"
